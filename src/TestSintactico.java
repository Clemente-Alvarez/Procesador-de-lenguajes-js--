...
public class TestSintactico {
    static final String INPUT_FILE_NAME = "grammar/test_input.txt"; 
    static final String CSV_FILE_NAME = "grammar/Accion-GoTo.csv"; 
    static final String TRACE_FILE_NAME = "grammar/Trace.txt"; 

    static final Rule[] GRAMMAR = {
    ...
    public static void main(String[] args) {
        try {
            ...
            analizadorSintactico parser = new analizadorSintactico(CSV_FILE_NAME, GRAMMAR, INPUT_FILE_NAME);

            List<String> trace = parser.compute();

            FileWriter tracFileWriter =new FileWriter(TRACE_FILE_NAME);
            //System.out.println("Parsing Trace:");
            for (String step : trace) {
                tracFileWriter.write(step + "\n");
                //System.out.println(step);
            }
            tracFileWriter.close();
